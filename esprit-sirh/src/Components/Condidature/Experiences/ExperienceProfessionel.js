                        ...
                        {items.map((item, index) =>
                          <tr key={index} >
                            ...
                            {(this.props.condidatReducer && !this.props.condidatReducer.aConfirmer &&
                              <div className="form-group">
                              <select
                                className={!this.state.ignorer && this.state.touched && this.state.touched[expProFields.etablissement + index] && item.etablissement.id == -1 ? "form-control form-control-sm invalide-field" : "form-control form-control-sm"}
                                id="sel1"
                              ...
                              {/* msg erreur */}
                              {!this.state.ignorer && this.state.touched && this.state.touched[expProFields.etablissement + index] && item.etablissement.id == -1 && (
